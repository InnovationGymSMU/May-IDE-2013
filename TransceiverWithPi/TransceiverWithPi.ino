...
//Packet book keeping
uint8_t node_type;//= 1;        //Type of node running this code: 1=TxRx, 2=Tx, 3=Rx
uint8_t nodeID_field;//= 5;     //Field indicating which node gathered the data
uint8_t next_hop = 4;         //node id of next hop in network
